...
import FeedAlert, { FeedAlertState } from "@/components/FeedAlert";
import FeedNetworkSignal from "@/components/FeedNetworkSignal";
import NoFeedAvailable from "@/components/NoFeedAvailable";
import VideoPlayer from "@/components/VideoPlayer";
import { PTZPayload, StreamStatus } from "../types";
import { cn, getStreamUrl, isIOS } from "@/utils";
...
export default function CameraFeed(props: Props) {
  ...
  const initializeStream = useCallback(async () => {
    ...
    setStreamUrl(getStreamUrl(props.asset));
    // await props
