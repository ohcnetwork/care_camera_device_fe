...
var AssetLocationType = /* @__PURE__ */ ((AssetLocationType2) => {
  AssetLocationType2["OTHER"] = "OTHER";
  AssetLocationType2["WARD"] = "WARD";
  AssetLocationType2["ICU"] = "ICU";
  return AssetLocationType2;
})(AssetLocationType || {});
var AssetType = /* @__PURE__ */ ((AssetType2) => {
  AssetType2["NONE"] = "NONE";
  AssetType2["INTERNAL"] = "INTERNAL";
  AssetType2["EXTERNAL"] = "EXTERNAL";
  return AssetType2;
})(AssetType || {});
var AssetClass = /* @__PURE__ */ ((AssetClass2) => {
  AssetClass2["NONE"] = "NONE";
  AssetClass2["ONVIF"] = "ONVIF";
  AssetClass2["HL7MONITOR"] = "HL7MONITOR";
  AssetClass2["VENTILATOR"] = "VENTILATOR";
  return AssetClass2;
})(AssetClass || {});

const {useEffect: useEffect$3} = await importShared('react');

function FeedAlert({ state }) {
  useEffect$3(() => {
    console.log(state);
  }, [state]);
...
const calculateVideoDelay = (ref, playedOn) => {
  const video = ref.current;
  if (!video || !playedOn) {
    return 0;
  }
  const playedDuration = ((/* @__PURE__ */ new Date()).getTime() - playedOn.getTime()) / 1e3;
  return playedDuration - video.currentTime;
};
const getStreamUrl = (asset, token) => {
...
function NetworkSignal({ strength, children }) {
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-0.5 p-1.5 md:p-2", children: [
          strength === void 0 ? /* @__PURE__ */ jsx(Fragment, {}) : Array.from({ length: 3 }, (_, i) => /* @__PURE__ */ jsx(
            "div",
            {
              className: cn(
                "w-1 rounded-sm",
          ...
          !!strength && strength < 2 && /* @__PURE__ */ jsx(Fragment, {})
        ] }),
        children
      ]
    }
...
function FeedNetworkSignal(props) {
  const [videoDelay, setVideoDelay] = useState$2();
  useEffect$2(() => {
  ...
  return /* @__PURE__ */ jsx(NetworkSignal, { strength: getStrength(props.status, videoDelay), children: /* @__PURE__ */ jsx("span", { className: "text-xs font-bold leading-none tracking-wide md:w-14", children: videoDelay ? `${videoDelay * 1e3 | 1} ms` : /* @__PURE__ */ jsx("span", { className: "font-normal text-white/50", children: "No signal" }) }) });
}
const getStrength = (status, videoDelay) => {
  if (status !== "playing" || videoDelay === void 0) {
    return 0;
  }
...
function NoFeedAvailable(props) {
  const redactedURL = props.streamUrl.replace(/[a-f\d]{8}-[a-f\d]{4}-[a-f\d]{4}-[a-f\d]{4}-[a-f\d]{12}/gi, "***").replace(/\/\d+/g, "/***");
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: cn(
      ...
      children: [
        /* @__PURE__ */ jsx("span", { className: "text-xs font-bold", children: props.message }),
        /* @__PURE__ */ jsx("span", { className: "hidden px-10 font-mono text-xs text-secondary-500 md:block", children: redactedURL })
      ]
    }
  );
}
...
function VideoPlayer(props) {
  ...
  const pushPacket = () => {
    ...
    try {
      if (bufLen > 0) {
        ...
        bufLen = 0;
        mseSourceBuffer.appendBuffer(data);
      } else if (mseSourceBuffer.buffered && mseSourceBuffer.buffered.length) {
        const end = mseSourceBuffer.buffered.end(mseSourceBuffer.buffered.length - 1) - 15;
  ...
  const startHLS = () => {
    ...
    try {
      if (!playerRef.current || !props.streamUrl)
        return;
  ...
  const startMSE = () => {
    try {
      ...
      mediaSource.onsourceopen = function() {
        ...
        ws.onopen = (_) => props.onSuccess?.(void 0);
...
const {useCallback,useEffect,useRef,useState: useState$1} = await importShared('react');

function CameraFeed(props) {
  const playerRef = useRef(null);
  const playerWrapperRef = useRef(null);
  const [streamUrl, setStreamUrl] = useState$1("");
  const [state, setState] = useState$1();
  const [playedOn, setPlayedOn] = useState$1();
  const [playerStatus, setPlayerStatus] = useState$1("stop");
  useEffect(() => {
    async function move(preset) {
      setState("moving");
      const { res } = await props.operate({
        type: "absolute_move",
        data: preset
      });
      setTimeout(() => setState((s) => s === "moving" ? void 0 : s), 4e3);
      if (res?.status === 500) {
  ...
  useEffect(() => {
    if (!props.onCameraPresetsObtained)
      return;
  ...
  return /* @__PURE__ */ jsx("div", { ref: playerWrapperRef, className: "flex h-full flex-col justify-center", children: /* @__PURE__ */ jsxs(
    "div",
    {
      children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx(
                ...
                {
                  className: cn(
                    playerStatus !== "playing" ? "pointer-events-none opacity-10" : "opacity-100",
                    "transition-all duration-200 ease-in-out"
                  ),
                  children: props.children
                }
              ),
              /* @__PURE__ */ jsxs("div", { className: "flex w-full flex-col items-end justify-end md:flex-row md:items-center md:gap-4", children: [
                !props.hideAssetInfo && /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsx("span", { className: "text-xs font-bold md:text-sm", children: props.asset.name }) }),
                !isIOS && /* @__PURE__ */ jsx(
                  "div",
                  {
                    className: cn(
        ...
        /* @__PURE__ */ jsxs("div", { className: "group relative flex-1 bg-black", children: [
          /* @__PURE__ */ jsx(FeedAlert, { state }),
          (() => {
            switch (state) {
...
async function request({ path, method, noAuth }, { query, body, pathParams, onResponse, signal } = {}) {
  ...
  try {
    ...
    result = {
      res,
      data: res.ok ? data : void 0,
      error: res.ok ? void 0 : data
    };
    onResponse?.(result);
    console.log(result);
    return result;
  } catch (error) {
    result = { error, res: void 0, data: void 0 };
...
function makeUrl(path, query, pathParams) {
  if (pathParams) {
...
const ensurePathNotMissingReplacements = (path) => {
...
function makeHeaders(noAuth, additionalHeaders) {
...
const sampleAsset = {
  ...
  meta: {
    ...
    camera_access_key: "remote_user:2jCkrCRSeahzKEU:73c8d78d-e7f4-491d-9ea7-743cd46f80a0",
...
const EncounterCameraFeedTab = (_props) => {
  const asset = sampleAsset;
  const { operate } = useOperateCamera(asset.id);
  return /* @__PURE__ */ jsx("div", { className: "w-full overflow-hidden rounded-lg bg-white shadow", children: /* @__PURE__ */ jsx(CameraFeed, { asset, operate }) });
};

export { EncounterCameraFeedTab as E, jsx as j };
